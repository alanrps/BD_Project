 ...
 * @author lucas
 */
public class BairroJDialog extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public BairroJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        try {
            loadRecords();
    ...
    private void initComponents() {
        ...
        jTableBairro.setColumnSelectionAllowed(true);
        jScrollPane4.setViewportView(jTableBairro);
        jTableBairro.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
    ...
    private void loadRecords() throws SQLException {
        String sql = "SELECT id as ID, nome as Nome FROM BAIRRO;";
