 ...
 * @author a1923161
 */
public class LinhaJDialog extends javax.swing.JDialog {

    /**
     * Creates new form BairroJDialog
     * @param parent
     * @param modal
     */
    public LinhaJDialog(java.awt.Frame parent, boolean modal){
        super(parent,modal);
        initComponents();
        try {
            loadRecords();
    ...
    private void loadRecords() throws SQLException {
        ...
        jTableLinha.setModel(tableModel);
        
        //Hiding column "id" 
        jTableLinha.removeColumn(jTableLinha.getColumnModel().getColumn(0));
        
       
        
        
        //Adjusting columns***
        jTableLinha.getColumnModel().getColumn(0).setMaxWidth(50);
       
        jTableLinha.getSelectionModel().addListSelectionListener((ListSelectionEvent event) -> {
            try {
                if (jTableLinha.getSelectedRow() >= 0) {
                    
                    Object id = jTableLinha.getModel().getValueAt(jTableLinha.getSelectedRow(), 0);
                    Object nome = jTableLinha.getModel().getValueAt(jTableLinha.getSelectedRow(), 1);
        ...
        jTableLinha.getColumnModel().getColumn(0).setCellRenderer(rightRenderer);
    }
